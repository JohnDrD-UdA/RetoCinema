...
describe('Chair Management Component', () => {
  let comp: ChairComponent;
  let fixture: ComponentFixture<ChairComponent>;
  let service: ChairService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'chair', component: ChairComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(ChairComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.chairs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
