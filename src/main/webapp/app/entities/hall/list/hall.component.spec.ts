...
describe('Hall Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'hall', component: HallComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.halls?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
